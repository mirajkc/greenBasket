              ...
              <tr>
                <td style="padding:28px 24px 8px 24px;color:#0b2a10;">
                  ...
                  <p style="margin:8px 0 0 0;color:#3b3b3b;font-size:15px;line-height:1.4;">
                    You're now part of the Green Basket family! We'll send you fresh deals, seasonal picks, and exclusive discounts.
                  </p>
                </td>
              </tr>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td style="width:33%;padding:8px;">
                        <a href="https://green-basket-egji.vercel.app/products" target="_blank"
                           style="display:block;text-align:center;padding:12px;border-radius:6px;border:1px solid #e6f1ea;text-decoration:none;color:#318039;font-weight:700;">
                          Fresh Picks
                        </a>
                      </td>
                      <td style="width:33%;padding:8px;">
                      ...
                      <td style="width:33%;padding:8px;">
                        <a href="https://green-basket-egji.vercel.app/my-orders" target="_blank"
                           style="display:block;text-align:center;padding:12px;border-radius:6px;border:1px solid #e6f1ea;text-decoration:none;color:#318039;font-weight:700;">
                          Your Account
                        </a>
                      </td>
              ...
              <tr>
                <td style="background:#f7faf7;padding:18px 24px;color:#6b6b6b;font-size:13px;">
                  ...
                  <p style="margin:0;color:#9aa79a;">
                    Green Basket • Fresh groceries delivered • 
                    <a href="https://green-basket-egji.vercel.app/unsubscribe?email=${encodeURIComponent(
                      emailaddress
                    )}"
                       style="color:#318039;text-decoration:none;">
                      Unsubscribe
                    </a>
                  </p>
                </td>
...
export const SendMail = async ({ emailaddress }) => {
  try {
    const response = await resend.emails.send({
      ...
      to: emailaddress,
      subject: 'Thanks for subscribing to Green Basket!',
      html: htmlBody(emailaddress),
    });

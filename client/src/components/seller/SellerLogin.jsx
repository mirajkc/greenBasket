...
const onSubmitHandler = async (e) => {
  ...
  return !isSeller &&  (
    <form onSubmit={onSubmitHandler} className='min-h-screen flex items-center text-sm text-gray-600 bg-gradient-to-br from-gray-50 to-gray-100'>
      <div className='flex flex-col gap-5 m-auto items-start p-8 py-12 min-w-80 sm:min-w-88 rounded-xl shadow-2xl border border-gray-200 bg-white backdrop-blur-sm transition-all duration-300 hover:shadow-3xl hover:scale-[1.01] animate-in slide-in-from-bottom-4 '>
        <p className='text-2xl font-bold m-auto text-gray-800 tracking-wide' ><span className='text-primary bg-gradient-to-r from-primary to-primary-dull bg-clip-text '>Seller</span> Login</p>
